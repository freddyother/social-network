...
func NewRouter(cfg config.Config, db *sql.DB) stdlibhttp.Handler {
	...
	mux.HandleFunc("PUT /api/v1/posts/{postID}/reaction", socialHandler.HandleSetPostReaction)
	mux.HandleFunc("DELETE /api/v1/posts/{postID}/reaction", socialHandler.HandleClearPostReaction)
	...
	mux.HandleFunc("PUT /api/v1/groups/{groupID}/posts/{postID}/reaction", socialHandler.HandleSetGroupPostReaction)
	mux.HandleFunc("DELETE /api/v1/groups/{groupID}/posts/{postID}/reaction", socialHandler.HandleClearGroupPostReaction)
	...
	mux.HandleFunc("PUT /api/v1/groups/{groupID}/posts/{postID}/comments/{commentID}/reaction", socialHandler.HandleSetGroupCommentReaction)
	mux.HandleFunc("DELETE /api/v1/groups/{groupID}/posts/{postID}/comments/{commentID}/reaction", socialHandler.HandleClearGroupCommentReaction)
	...
	mux.HandleFunc("GET /api/v1/groups/{groupID}/members", socialHandler.HandleGroupMembers)
	...
	mux.HandleFunc("PUT /api/v1/posts/{postID}/comments/{commentID}/reaction", socialHandler.HandleSetCommentReaction)
	mux.HandleFunc("DELETE /api/v1/posts/{postID}/comments/{commentID}/reaction", socialHandler.HandleClearCommentReaction)
