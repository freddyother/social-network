...
type socialService interface {
	...
	SetPostReaction(ctx context.Context, userID, postID, reactionType string) (social.ReactionResult, error)
	ClearPostReaction(ctx context.Context, userID, postID string) (social.ReactionResult, error)
	...
	GroupMembers(ctx context.Context, viewerID, groupID string) ([]social.GroupMember, error)
	...
	SetGroupPostReaction(ctx context.Context, userID, groupID, groupPostID, reactionType string) (social.ReactionResult, error)
	ClearGroupPostReaction(ctx context.Context, userID, groupID, groupPostID string) (social.ReactionResult, error)
	...
	SetGroupCommentReaction(ctx context.Context, userID, groupID, groupPostID, commentID, reactionType string) (social.ReactionResult, error)
	ClearGroupCommentReaction(ctx context.Context, userID, groupID, groupPostID, commentID string) (social.ReactionResult, error)
	...
	SetCommentReaction(ctx context.Context, userID, postID, commentID, reactionType string) (social.ReactionResult, error)
	ClearCommentReaction(ctx context.Context, userID, postID, commentID string) (social.ReactionResult, error)
