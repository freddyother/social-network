...
VALUES
    ('demo-user-01', 'seed-user-01', '01', 'luna.ortega@example.test', 'luna_ortega'),
    ('demo-user-02', 'seed-user-02', '02', 'mateo.silva@example.test', 'mateosilva'),
    ('demo-user-03', 'seed-user-03', '03', 'sofia.moreau@example.test', 'sofia_moreau'),
    ('demo-user-04', 'seed-user-04', '04', 'noah.bennett@example.test', 'noahbennett'),
    ('demo-user-05', 'seed-user-05', '05', 'isabel.costa@example.test', 'isabelcosta'),
    ('demo-user-06', 'seed-user-06', '06', 'elias.hart@example.test', 'eliashart'),
    ('demo-user-07', 'seed-user-07', '07', 'maya.singh@example.test', 'maya_singh'),
    ('demo-user-08', 'seed-user-08', '08', 'leo.navarro@example.test', 'leonavarro'),
    ('demo-user-09', 'seed-user-09', '09', 'amara.wilson@example.test', 'amara_wilson'),
    ('demo-user-10', 'seed-user-10', '10', 'theo.martin@example.test', 'theomartin'),
    ('demo-user-11', 'seed-user-11', '11', 'valeria.rossi@example.test', 'valeria_rossi'),
    ('demo-user-12', 'seed-user-12', '12', 'nico.alvarez@example.test', 'nicoalvarez'),
    ('demo-user-13', 'seed-user-13', '13', 'eva.kim@example.test', 'evakim'),
    ('demo-user-14', 'seed-user-14', '14', 'julian.price@example.test', 'julianprice'),
    ('demo-user-15', 'seed-user-15', '15', 'camila.lopez@example.test', 'camila_lopez'),
    ('demo-user-16', 'seed-user-16', '16', 'lucas.meyer@example.test', 'lucasmeyer'),
    ('demo-user-17', 'seed-user-17', '17', 'sara.dubois@example.test', 'saradubois'),
    ('demo-user-18', 'seed-user-18', '18', 'daniel.brooks@example.test', 'danielbrooks'),
    ('demo-user-19', 'seed-user-19', '19', 'nina.petrov@example.test', 'ninapetrov'),
    ('demo-user-20', 'seed-user-20', '20', 'oscar.reed@example.test', 'oscarreed');
...
SELECT
    m.new_id,
    'seed.transition.' || m.nn || '@example.test',
    u.password_hash,
    u.first_name,
    u.last_name,
    u.date_of_birth,
    u.avatar_url,
    'seed_transition_' || m.nn,
    u.about_me,
